...
from mytest.search_user import SearchUser
...
# python examples/search.py -a examples/configs/vpg.json -n examples/configs/mlp2_network.json -e 2000 -m 200
...
def main():
    ...
    ### test ###
    print("------ test output ------")
    print("states: %s" % str(environment.states))
    print("actions: %s" % str(environment.actions))
    ...
    def episode_finished(r, id_):
        ...
        with open("./mytest/log/envs_{}__agent_{}".format(environment, agent), "a") as logf:
            logf.write("episode: " + str(r.agent.episode) + "\n")
            logf.write("reward: " + str(r.episode_rewards[-1]) + "\n")
            logf.write("timesteps: " + str(r.episode_timestep) + "\n")
